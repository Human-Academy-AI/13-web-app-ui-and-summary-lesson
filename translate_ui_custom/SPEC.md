# 仕様書（5W1H）: translate_ui_custom

## 1. Why（なぜ作るか）
- 教材として「仕様書ベースAIコーディング」の流れを体験するため
- 翻訳Webアプリの体裁を整え、学習者が「UIの完成度の違い」を比較できるようにするため
- AIはライブラリ無しでも細かな装飾が可能だが、設計の意図を人が明示する重要性を体験するため
- コーディングはAIが行う前提で、学習者は仕様書をAIと相談しながら作成し、AIコーディング能力を高めるため

## 2. What（何を作るか）
- 多言語翻訳WebアプリのフロントUI（カスタムHTML/CSS版）
